...
sed -i "s/^#\(jira_pass\):.*/\1: "$PASSWD"/g" group_vars/all
sed -i "s/^#\(postgresql_db_encoding\):.*/\1: UTF8/g" group_vars/all
sed -i "s/^#\(postgresql_db_name\):.*/\1: jira/g" group_vars/all
sed -i "s/^#\(postgresql_db_owner\):.*/\1: jira/g" group_vars/all
sed -i "s/^#\(postgresql_db_template\):.*/\1: template0/g" group_vars/all
sed -i "s/^#\(postgresql_user_name\):.*/\1: jira/g" group_vars/all
